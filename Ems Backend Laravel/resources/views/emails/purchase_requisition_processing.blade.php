...
<html lang="en">
    ...
    <body>
        ...
        <p>
            Your Application for Purchase Requisition with Following Information has been Approved By {{$approval->approvee()->name}}.
        </p>
        ...
        <ul>
            @foreach ($purchase_requisition->approvers() as $approvalR)
                <p>
